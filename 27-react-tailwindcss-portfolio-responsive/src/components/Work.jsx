...
import projectImage1 from '../assets/proj1.png'
import projectImage2 from '../assets/proj2.png'
import projectImage3 from '../assets/proj3.png'
import projectImage4 from '../assets/proj4.png'
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
          <a href="/" className="group h-48 overflow-hidden rounded-lg shadow-lg md:h-80">
            <img
              ...
              src={projectImage1} alt="project-image"
            />
          </a>
          <a href="/" className="group h-48 overflow-hidden rounded-lg shadow-lg  md:col-span-2 md:h-80">
            <img
              className="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
              src={projectImage2} alt="project-image"
            />
          </a>
          <a href="/" className="group h-48 overflow-hidden rounded-lg shadow-lg  md:col-span-2 md:h-80">
            <img
              className="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
              src={projectImage3} alt="project-image"
            />
          </a>
          <a href="/" className="group h-48 overflow-hidden rounded-lg shadow-lg md:h-80">
            <img
              className="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
              src={projectImage4} alt="project-image"
            />
          </a>
        </div>
      </div>
