  ...
  return (
    <footer className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div>
        ...
        <p className="py-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem, libero. Aspernatur rerum iste provident! Ut, expedita esse perferendis quis labore animi ullam, facilis molestias in est nobis autem repudiandae ab.</p>
      ...
      <div className="lg:col-span-2 flex justify-between">
        ...
        <div>
          ...
          <ul>
            ...
            <li className="py-2 text-sm">Documations</li>
